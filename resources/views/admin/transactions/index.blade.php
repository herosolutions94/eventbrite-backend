                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    ...
                                    @foreach ($data as $transaction)
                                        <tr>
                                            <td>
                                                {{ !empty($transaction->user_row) ? $transaction->user_row->name." < ".$transaction->user_row->email." > " : 'N/A' }}
                                            </td>
                                            <td>
                                                {{ format_amount($transaction->amount) }}
                                            </td>
                                            <td>
                                                {{ format_date($transaction->created_at,'M d, Y') }}
                                            </td>
                                            <!--end::Type=-->
                                            <!--begin::Action=-->
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="javascript::" onclick="deleteRecord('{{ route('admin.transactions.destroy', $transaction->id) }}')"
