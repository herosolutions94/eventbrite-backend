                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-row justify-content-between flex-wrap me-3 w-100">
                        ...
                        <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">View
                            {{$user->role=='player' ? 'Player' : "Organizer"}} Details</h1>
                        <!--end::Title-->
                        <!--begin::Breadcrumb-->
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            @if($user->role=='player')
                            <a href="{{ url('/admin/players/index') }}" class="btn btn-sm fw-bold btn-light btn-outline">Back</a>
                            <a href="{{ url('/admin/players/edit/'.$user->id) }}" class="btn btn-sm fw-bold btn-primary">Edit</a>
                            @else
                                        ...
                                        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
											...
											<div class="me-7 mb-4">
                                                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                                    <img src="{{get_site_image_src('uploads', !empty($user) ? $user->user_image : '')}}" alt="image" />
